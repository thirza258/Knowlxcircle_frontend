        ...
        <div className="container py-4 py-lg-5">
            <div className="row justify-content-center">
                ...
                <div className="col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last item social">
                    <div className="fw-bold d-flex align-items-center mb-2"><span className="title">Knowlxcircle</span></div>
                    <p className="text-muted copyright">Community Skill Sharing</p>
                </div>
            </div>
            <hr />
