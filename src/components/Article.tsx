...
const Article = () => {
    ...
    useEffect(() => {
        const fetchArticle = async () => {
            try {
                const articleData = await ArticleService.getArticlesById();
    ...
    return (
        <div className="grid grid-cols-5 gap-4">
            ...
            <div className="col-span-4 row-span-1 bg-gray-300 p-4">
                <h2 className="text-center font-bold text-4xl font-sans bg-gradient-to-r from-blue-500 to-blue-700 text-[] bg-clip-text">
                    {article.title}
                </h2>
            </div>
            ...
            <div className="col-span-4 row-span-1 bg-gray-300 p-4">
                {article.sections.map((section) => (
                    <div key={section.id} className="font-bold text-black font-sans text-base">
